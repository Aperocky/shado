...
// 	Requires that this variable be set to either 'conductor' or 'engineer'.
//	$operator_type

	if ($operator_type == 'conductor') {
		$file_handle=fopen('sessions/Conductor_stats.csv','r');
		$file=fopen("sessions/mod_type_data_conductor.txt","w");
	} elseif ($operator_type == 'engineer') {
...
<meta charset="utf-8">
	<div class="page">
		<div class="operator_graph_container">
			<div id="graph2"></div>
		</div>

<style>

	.operator_graph_container{
		text-align: center;
	}
