...
?>
			<div id="homePage" class="page">
				<h1 class="pageTitle">Welcome to the SHADO!</h1>
				<h2>Introduction</h2>
                <p>
                    Welcome to the <u>S</u>imulator of <u>H</u>umans and <u>A</u>utomation in <u>D</u>ispatch <u>O</u>perations (SHADO)!
                    This tool, designed by Duke University researchers, simulates the workload of a dispatch operator and associated freight
                    rail operators across the duration of a given shift. With SHADO, you can choose a trip with unique conditions and then
                    see the operators' average workload after thousands of similar shifts.
                </p>
				<p>
